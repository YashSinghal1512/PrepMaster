...
st.set_page_config(
    page_title="PrepMaster"
)

st.sidebar.success("Select a page above")

st.title("Welcome to PrepMaster")

# Introduction
st.markdown(
    """
    PrepMaster is an interview helper app designed to support you in getting ready for job interviews. Whether you need a comprehensive roadmap, interview questions or experience, or helpful cheat sheets, we have you covered. Additionally, you can create a personalized cover letter. Begin by selecting a page from the sidebar to initiate the process.
    """
)
